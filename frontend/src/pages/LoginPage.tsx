      ...
      <div className="w-full max-w-md overflow-hidden rounded-2xl border border-surface-active bg-surface shadow-2xl transition-all duration-300 hover:shadow-accent/10">
        <div className="p-8">
          <div className="mb-8 text-center">
            <h1 className="mb-2 text-3xl font-bold tracking-tight text-text">Welcome Back</h1>
            <p className="text-sm text-text-secondary">Sign in to your SceneFlow account</p>
          </div>
